...
summary: "Panduan komprehensif penulisan dokumen menggunakan sintaks Markdown versi Pandoc, mencakup pemformatan teks, tabel, kode program, gambar, hingga catatan kaki dan referensi."
description: "Panduan komprehensif penulisan dokumen menggunakan sintaks Markdown versi Pandoc, mencakup pemformatan teks, tabel, kode program, gambar, hingga catatan kaki dan referensi."
categories: ["Pandoc"]
...
Untuk membuat _huruf miring_, gunakan karakter `*` atau `_`. Contohnya:
...
> Penulisan kode program di Java adalah _case sensitive_.
> Berbeda dengan SQL yang _case insensitive_.
...
> Penulisan kode program di Java adalah **case sensitive**.
> Berbeda dengan SQL yang **case insensitive**.
