...
<div class="mt-4 mb-4">
    ...
    <input class="shadow appearance-none border border-orange-300 dark:border-orange-700 rounded w-full py-2 px-3 text-gray-700 dark:text-gray-200 dark:bg-neutral-800 leading-tight focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500" id="subject" name="subject" type="text" placeholder="Subject..." required="required">
</div>
<div class="mt-4 mb-6">
...
<div class="g-recaptcha mb-8" data-sitekey="6LejQ7ctAAAAAGEkSe4HMil_HRx6skJ9BXz_VneB"></div>
